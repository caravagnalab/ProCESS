...
[this article](mutations.html), ProCESS can simulate
...
```{r, fig.alt=c("A plot depicting the Variant Allele Frequency (VAF) of a sequenced sample.", "A plot depicting the B-Allele Frequency (BAF) of a sequenced sample.", "A plot depicting the Depth Ratio (DR) of a sequenced sample.")}
library(dplyr)
