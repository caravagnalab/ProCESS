...
```{r, fig.height=4, fig.width=3, fig.alt=c("The tissue of a tumour having one mutant/species.")}
library(ProCESS)
...
```{r,  fig.height=4, fig.width=3, fig.alt=c("The tissue of a tumour having one mutant/species after two samples have been collected.")}
n_w <- n_h <- 7
ncells <- 0.8 * n_w * n_h
...
```{r,  fig.height=4, fig.width=3, fig.alt=c("The tissue of the tumour after a second mutant arises.", "The Muller plot of the tumour after a second mutant arises.")}
# New submutant
...
```{r,  fig.height=4, fig.width=3, fig.alt=c("Two further samples have been collected from the tissue of the biclonal tumour.")}
...
```{r,  fig.height=4, fig.width=3, fig.alt=c("The tissue of the tumour after a third mutant arises.", "The Muller plot of the tumour after a third mutant arises.")}
# New submutant
...
```{r,  fig.height=4, fig.width=3, fig.alt=c("The tumour just after two further samples have been collected.")}
# Sampling with random box sampling
bbox <- sim$search_sample(c("B" = ncells), n_w, n_h)
...
```{r,  fig.height=12, fig.width=17, fig.alt=c("The sample forest of the samples.")}
# Tree data
