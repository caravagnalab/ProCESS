...
epigenetic state_" in [this article](sampling.html). It involves the two
mutants `A` and `B`. Both of them have two possible epigenetic states, 
`+` and `-`, leading to the four species `A+`, `A-`, `B+`, and `B-`,
respectively.
...
rates be 0 for all the species, but `A+`, which has an indel rate of 1e-8.
...
The method <code>[MutationEngine$add_mutant()](../reference/MutationEngine-cash-add_mutant.html)</code>
...
by using the method 
<code>[MutationEngine$get_known_drivers()](../reference/MutationEngine-cash-get_known_drivers.html)</code>.
...
<code>[MutationEngine$add_exposure()](../reference/MutationEngine-cash-add_exposure.html)</code> as follows.
...
<code>[MutationEngine$get_germline_subjects()](../reference/MutationEngine-cash-get_germline_subjects.html)</code>.
...
The method 
<code>[MutationEngine$get_population_descriptions()](../reference/MutationEngine-cash-get_population_descriptions.html)</code> 
...
The method 
<code>[MutationEngine$get_active_germline()](../reference/MutationEngine-cash-get_active_germline.html)</code> returns the
...
<code>[MutationEngine$set_germline_subject()](../reference/MutationEngine-cash-set_germline_subject.html)</code>.
...
epigenetic state_" in [this article](sampling.html),
...
<code>[PhylogeneticForest$get_sampled_cell_mutations()](../reference/PhylogeneticForest-cash-get_sampled_cell_mutations.html)</code>
and
<code>[PhylogeneticForest$get_sampled_cell_CNAs()](../reference/PhylogeneticForest-cash-get_sampled_cell_CNAs.html)</code>.
...
The method 
<code>[PhylogeneticForest$get_samples_info()](../reference/PhylogeneticForest-cash-get_samples_info.html)</code> is analogous to
<code>[SampleForest$get_samples_info()](../reference/SampleForest-cash-get_samples_info.html)</code>: it returns a data frame containing
...
The method <code>[PhylogeneticForest$get_germline_mutations()](../reference/PhylogeneticForest-cash-get_germline_mutations.html)</code> returns
...
<code>[PhylogeneticForest$get_exposures()](../reference/PhylogeneticForest-cash-get_exposures.html)</code>.
...
The method <code>[MutationEngine$get_bulk_allelic_fragmentation()](../reference/MutationEngine-cash-get_bulk_allelic_fragmentation.html)</code> 
...
Instead, the method <code>[MutationEngine$get_cell_allelic_fragmentation()](../reference/MutationEngine-cash-get_cell_allelic_fragmentation.html)</code> 
...
<code>[MutationEngine$get_SNV_signatures()](../reference/MutationEngine-cash-get_SNV_signatures.html)</code> 
and
<code>[MutationEngine$get_indel_signatures()](../reference/MutationEngine-cash-get_indel_signatures.html)</code>.
...
<code>[PhylogeneticForest$get_germline_subject()](../reference/PhylogeneticForest-cash-get_germline_subject.html)</code>.
...
<code>[PhylogeneticForest$save()](../reference/PhylogeneticForest-cash-save.html)</code> 
...
The methods 
<code>[PhylogeneticForest$get_reference_path()](../reference/PhylogeneticForest-cash-get_reference_path.html)</code> and
<code>[PhylogeneticForest$set_reference_path()](../reference/PhylogeneticForest-cash-set_reference_path.html)</code> 
