...
while (dir.exists("four_mutants")
       || file.exists("fm_sample_forest.sff")) {
  Sys.sleep(0.3)
}
...
sim <- TissueSimulation(width = 600, height = 600, name = "four_mutants",
                        save_directory = TRUE)
...
plot_tissue(sim) +
  ggplot2::annotate("text", x = (100 + 170) / 2, y = (400 + 470) / 2,
                    label = "S3", parse = TRUE)
