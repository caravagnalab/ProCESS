...
programmed using ProCESS (see the [article on tissue simulation](tissue_simulation.html)), the next
...
> box after application of <code>[TissueSimulation$sample_cells()](../reference/TissueSimulation-cash-sample_cells.html)</code>
...
This is also reflected by <code>[TissueSimulation$get_cells()](../reference/TissueSimulation-cash-get_cells.html)</code>,
...
Since the mutant start has been randomised by
<code>[TissueSimulation$choose_cell_in()](../reference/TissueSimulation-cash-choose_cell_in.html)</code>,
we have no exact idea of where to sample to obtain, for example, $100$ of
its cells.We can visually inspect the simulation, but it is slow.

ProCESS provides a 
<code>[TissueSimulation$search_sample()](../reference/TissueSimulation-cash-search_sample.html)</code>
...
<code>[SampleForest$save()](../reference/SampleForest-cash-save.html)</code>.
