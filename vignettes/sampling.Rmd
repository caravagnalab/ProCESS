...
```{r,  fig.height=6, fig.width=11, fig.alt=c("The samples forest of S_1_1 and S_1_2.")}
plot_forest(forest)
```
...
We can build the samples forest.
...
```{r, fig.alt=c("Two further samples S_2_3 and S_2_4 are collected. Their cells are randomly picked-up (like in liquid biopsy) from the whole tissue and from a bounding box, respectively. The figure depicts the samples forest of all the samples.")}
...
Now we show the samples forest, which starts being rather
complicated
