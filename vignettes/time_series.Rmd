...
methods, CLONES stores the data about the number of species cells, and
...
`TissueSimulation$history_delta` to increase the sampling rate of
the state (by default, `TissueSimulation$history_delta` is set to $0$).
...
ancestor mutant. Note however that reversible epistates do not fit a
