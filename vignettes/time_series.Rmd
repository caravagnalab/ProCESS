...
```{r,  fig.height=4, fig.width=6, message=FALSE, warning=FALSE, fig.alt=c("The Muller plot for the last quater of the simulation after changing the death rates of B and C species.", "The Muller plot in log-scale  for the last quater of the simulation after changing the death rates of B and C species.")}
# Current rates
sim
