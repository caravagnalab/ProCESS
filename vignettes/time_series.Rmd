...
# Create a tissue simulation whose tissue has size 1200x900
...
> Refer to [this article](tissue_simulation.html)
...
[this article](tissue_simulation.html).
...
<code>[TissueSimulation$history_delta](../reference/TissueSimulation-cash-history_delta.html)</code>
to increase the sampling rate of
the state (by default, <code>[TissueSimulation$history_delta](../reference/TissueSimulation-cash-history_delta.html)</code> is set to $0$).
