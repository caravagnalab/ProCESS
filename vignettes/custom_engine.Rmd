...
(i.e., a triplet of consecutive nucleotides), the probability for a SNV
...
For instance, the complete context index of a human genome takes about 12GBytes.
...
Analogously to the SBS signatures, the ID (indel) signatures fixes, for
