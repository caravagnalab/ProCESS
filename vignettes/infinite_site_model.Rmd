...
[this article](mutations.html) and verify
...
# 3e-8, respectively, passenger indel rates 1e-9 and 1e-11, respectively,
...
# as done above. The species "B+" and "B-" have passenger SNV rates 1e-8
# and 5e-8, respectively, and CNA rates 0 for both species.
m_engine$add_mutant("B", list("+" = c(SNV = 1e-8), "-" = c(SNV = 5e-8)),
...
<code>[MutationEngine$infinite_sites_model](../reference/MutationEngine-cash-infinite_sites_model.html)</code>. 
...
<code>[MutationEngine$place_mutations()](../reference/MutationEngine-cash-place_mutations.html)</code> may place two mutations
