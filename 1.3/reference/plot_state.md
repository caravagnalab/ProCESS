...
A pie chart with population counts, split by species and epigentic
state. It also provides annotations for the simulation data.

## Usage

``` r
plot_state(simulation, color_map = NULL)
```
