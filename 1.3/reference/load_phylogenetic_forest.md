...
This method loads a phylogenetic forest from a file.

## Usage

``` r
load_phylogenetic_forest(filename, quiet)
```
...
- filename:
  ...
  The path of the file from which the phylogenetic forest must be
  loaded.
...
The loaded phylogenetic forest
