...
`# define evolutionary parameters`` ``sim``$``add_mutant``(``"C"``, `[`list`](https://rdrr.io/r/base/list.html)`(``E1 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.2``, death ``=`` ``0.1``,`` `` E2 ``=`` ``0.1``)``,`` `` E2 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.4``, death ``=`` ``0.01``,`` `` E1 ``=`` ``0.1``)``)``)`` `` ``# choose a border cell in A[E1] or A[E2] in the rectangle [450,500]x[550,650]`` ``cell`` ``<-`` ``sim``$``choose_border_cell_in``(`[`c`](https://rdrr.io/r/base/c.html)`(``"A[E1]"``, ``"A[E2]"``)``,`` `` `[`c`](https://rdrr.io/r/base/c.html)`(``450``, ``550``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``500``, ``650``)``)`` `` ``sim``$``mutate_progeny``(``cell``, ``"C"``)`` `` ``sim``$``run_up_to_time``(``sim``$``get_clock``(``)`` ``+`` ``7``)`` ``#> [███████████████████████████████████████-] 97% [00m:00s] Cells: 203570 [████████████████████████████████████████] 98% [00m:01s] Cells: 212694 [████████████████████████████████████████] 99% [00m:02s] Cells: 219040 [████████████████████████████████████████] 99% [00m:02s] Cells: 225473 [████████████████████████████████████████] 100% [00m:03s] Saving snapshot`
