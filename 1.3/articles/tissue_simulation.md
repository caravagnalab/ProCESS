...
`` # mutate one of the children of `cell` into the species "B" ``` ``sim``$``mutate_progeny``(``cell``, ``"B"``)`` `` ``# generated event A -> B either in any of the added epi-states`` ``sim``$``get_counts``(``)`` ``#> mutant epistate counts overall`` ``#> 1 A E1 7056 53922`` ``#> 2 A E2 2111 7807`` ``#> 3 A E3 395 1258`` ``#> 4 A E4 0 0`` ``#> 5 B E1 1 1`` ``#> 6 B E2 0 0`` ``#> 7 B E3 0 0`` ``#> 8 B E4 0 0`` `` ``# evolve the simulation until "B[E2]" consists of less than 1e4 cells`` ``sim``$``run_up_to_size``(``"B[E2]"``, ``10000``)`` ``#> [█████-----------------------------------] 12% [00m:00s] Cells: 38446 [███████████-----------------------------] 25% [00m:00s] Cells: 60540 [███████████████-------------------------] 35% [00m:01s] Cells: 75761 [██████████████████----------------------] 44% [00m:02s] Cells: 90988 [█████████████████████-------------------] 52% [00m:03s] Cells: 104647 [████████████████████████----------------] 58% [00m:04s] Cells: 116659 [███████████████████████████-------------] 65% [00m:05s] Cells: 128210 [█████████████████████████████-----------] 70% [00m:06s] Cells: 138726 [███████████████████████████████---------] 77% [00m:07s] Cells: 148999 [█████████████████████████████████-------] 82% [00m:08s] Cells: 158506 [████████████████████████████████████----] 88% [00m:09s] Cells: 166917 [██████████████████████████████████████--] 93% [00m:10s] Cells: 175073 [████████████████████████████████████████] 98% [00m:11s] Cells: 183093 [████████████████████████████████████████] 100% [00m:12s] Saving snapshot`
...
[`plot_tissue`](https://caravagnalab.github.io/ProCESS/1.3/reference/plot_tissue.md)`(``sim``, num_of_bins ``=`` ``250``)`` ``+`` ``ggplot2``::`[`facet_wrap`](https://ggplot2.tidyverse.org/reference/facet_wrap.html)`(``~``species``)`
...
`# define evolutionary parameters`` ``sim``$``add_mutant``(``"C"``, `[`list`](https://rdrr.io/r/base/list.html)`(``E1 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.2``, death ``=`` ``0.1``,`` `` E2 ``=`` ``0.1``)``,`` `` E2 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.4``, death ``=`` ``0.01``,`` `` E1 ``=`` ``0.1``)``)``)`` `` ``# choose a border cell in A[E1] or A[E2] in the rectangle [450,500]x[550,650]`` ``cell`` ``<-`` ``sim``$``choose_border_cell_in``(`[`c`](https://rdrr.io/r/base/c.html)`(``"A[E1]"``, ``"A[E2]"``)``,`` `` `[`c`](https://rdrr.io/r/base/c.html)`(``450``, ``550``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``500``, ``650``)``)`` `` ``sim``$``mutate_progeny``(``cell``, ``"C"``)`` `` ``sim``$``run_up_to_time``(``sim``$``get_clock``(``)`` ``+`` ``7``)`` ``#> [███████████████████████████████████████-] 97% [00m:00s] Cells: 205579 [████████████████████████████████████████] 98% [00m:00s] Cells: 213517 [████████████████████████████████████████] 99% [00m:01s] Cells: 220068 [████████████████████████████████████████] 100% [00m:02s] Saving snapshot`
