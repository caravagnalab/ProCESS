...
`` # mutate one of the children of `cell` into the species "B" ``` ``sim``$``mutate_progeny``(``cell``, ``"B"``)`` `` ``# generated event A -> B either in any of the added epi-states`` ``sim``$``get_counts``(``)`` ``#> mutant epistate counts overall`` ``#> 1 A E1 7056 46866`` ``#> 2 A E2 2111 5696`` ``#> 3 A E3 395 863`` ``#> 4 A E4 0 0`` ``#> 5 B E1 1 1`` ``#> 6 B E2 0 0`` ``#> 7 B E3 0 0`` ``#> 8 B E4 0 0`` `` ``# evolve the simulation until "B[E2]" consists of less than 1e4 cells`` ``sim``$``run_up_to_size``(``"B[E2]"``, ``10000``)`` ``#> [█████-----------------------------------] 12% [00m:00s] Cells: 37684 [███████████-----------------------------] 25% [00m:00s] Cells: 60878 [███████████████-------------------------] 36% [00m:01s] Cells: 77612 [██████████████████----------------------] 44% [00m:02s] Cells: 90952 [█████████████████████-------------------] 51% [00m:03s] Cells: 103851 [████████████████████████----------------] 58% [00m:04s] Cells: 115432 [██████████████████████████--------------] 64% [00m:05s] Cells: 124976 [████████████████████████████------------] 68% [00m:06s] Cells: 134575 [██████████████████████████████----------] 74% [00m:07s] Cells: 143365 [████████████████████████████████--------] 79% [00m:08s] Cells: 152466 [██████████████████████████████████------] 84% [00m:09s] Cells: 161567 [█████████████████████████████████████---] 90% [00m:10s] Cells: 169788 [██████████████████████████████████████--] 94% [00m:11s] Cells: 176916 [████████████████████████████████████████] 98% [00m:12s] Cells: 184298 [████████████████████████████████████████] 100% [00m:13s] Saving snapshot`
...
`# define evolutionary parameters`` ``sim``$``add_mutant``(``"C"``, `[`list`](https://rdrr.io/r/base/list.html)`(``E1 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.2``, death ``=`` ``0.1``,`` `` E2 ``=`` ``0.1``)``,`` `` E2 ``=`` `[`list`](https://rdrr.io/r/base/list.html)`(``duplication ``=`` ``0.4``, death ``=`` ``0.01``,`` `` E1 ``=`` ``0.1``)``)``)`` `` ``# choose a border cell in A[E1] or A[E2] in the rectangle [450,500]x[550,650]`` ``cell`` ``<-`` ``sim``$``choose_border_cell_in``(`[`c`](https://rdrr.io/r/base/c.html)`(``"A[E1]"``, ``"A[E2]"``)``,`` `` `[`c`](https://rdrr.io/r/base/c.html)`(``450``, ``550``)``, `[`c`](https://rdrr.io/r/base/c.html)`(``500``, ``650``)``)`` `` ``sim``$``mutate_progeny``(``cell``, ``"C"``)`` `` ``sim``$``run_up_to_time``(``sim``$``get_clock``(``)`` ``+`` ``7``)`` ``#> [███████████████████████████████████████-] 97% [00m:00s] Cells: 203616 [████████████████████████████████████████] 98% [00m:01s] Cells: 211798 [████████████████████████████████████████] 98% [00m:01s] Cells: 217568 [████████████████████████████████████████] 99% [00m:02s] Cells: 223483 [████████████████████████████████████████] 100% [00m:03s] Saving snapshot`
