...
SIDMut SIDMut::build_SNV(const SEXP chromosome_name, const SEXP position_in_chromosome,
                         const SEXP alt_base, const SEXP ref_base, const SEXP allele_id,
                         const SEXP cause)
{
    SIDMut mutation = build_SID(chromosome_name, position_in_chromosome, ref_base,
                                alt_base, allele_id, cause);
...
SIDMut SIDMut::build_SID(const SEXP chromosome_name, const SEXP position_in_chromosome,
                         const SEXP ref_base, const SEXP alt_base, const SEXP allele_id,
                         const SEXP cause)
{
    using namespace Rcpp;
    using namespace CLONES::Mutations;
